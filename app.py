...
def signUp():
        conn=psycopg2.connect(user='yruiz',password='tPHFSHwcnIcAcnTeBHMe1Dx5tp50KAsk',host='dpg-cl5g5ml6fh7c73empqqg-a.oregon-postgres.render.com',port='5432',database='pethotel_xz2s')
    # create user code will be here !!
...
def page_not_found(error):
    return render_template("error1.html", error="Página no encontrada..."), 404
